function json2svg(){
  ...
  //$("#mySVG").setAttribute("data","svg/G01856RL.svg");
...
//document.getElementById("mySVG").addEventListener("load",function(){
  //function checkReady(){
    svgObj = document.getElementById("mySVG");
    svgDoc = svgObj.contentDocument;
    sNode = svgDoc.getElementsByClassName("sugar");
    sBond = svgDoc.getElementsByClassName("bond");
    sText = svgDoc.getElementsByClassName("sText");
...
// $("#infoDiv1").css("width","100px"); // Column No3 upper-div
// $("#infoDiv2").css("width","100px"); // Column No3 lower-div
