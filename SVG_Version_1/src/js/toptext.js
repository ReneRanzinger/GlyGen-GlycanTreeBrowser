function json2svg(parentWidth,parentHeight,leftSide,rightSide){
      // $("#mainPage").append($(" <ul id='myUL' >  <li><span class= 'caret' >Nodes</span> <ul id='ul_bev' class='nested' ></ul> </li><li><span class='caret'>Enzymes</span>  <ul id='ul_tea' class='nested' ></ul></li></ul> <div id='infoDiv1'> <center> RESIDUE PROPERTIES WILL BE DISPLAYED HERE </center></div><div id='infoDiv2'> <center>ENZYMES</center></div>"));
...
// Function to set the height and
  ...
  //     $("#myUL").css("width",leftSide);
  //     $("#mySVG").css("width",svgWidth);
  //     $("#mySVG").css("height",parentHeight);
  //     $("#infoDiv1").css("width",rightSide);
  //     $("#infoDiv1").css("height",(parentHeight/2));
  //     $("#infoDiv2").css("width",rightSide);
  //     $("#infoDiv2").css("height",(parentHeight/2));



$(function(){
  $("#myUL").css("width","256px"); // Column No1 of the Menu Options
  $("#infoDiv1").css("width","270px"); // Column No3 upper-div
  $("#infoDiv2").css("width","270px"); // Column No3 lower-div

  $("#myUL").css("height","603px");
  $("#infoDiv1").css("height","300px"); // Column No3 upper-div
  $("#infoDiv2").css("height","302px"); // Column No3 lower-div
